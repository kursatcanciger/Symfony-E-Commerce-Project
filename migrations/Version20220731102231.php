 ...
 */
final class Version20220731102231 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_64C19C1796A8F92 ON category');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_64C19C1796A8F92 ON category (parent_category_id)');
    }
}
